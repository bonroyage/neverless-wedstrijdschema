...
for team in range(1, 16):  # 1 tot 15
    team_toevoegen()
...
def team_mag_spelen(wedstrijd: Wedstrijd, team: Team) -> bool:
    ...
    """ Een team mag niet 3 of meer rondes geen wedstrijd spelen. """
    laatste_ronde = team.laatste_ronde_in_week(wedstrijd.week)
    if laatste_ronde is not None and (wedstrijd.ronde - laatste_ronde) > 3:
        return False
